...
readingMinutes: 7
results:
  - label: "Deflection data points"
    value: "4 stiffness-scale checkpoints (surrogate vs truth)"
  - label: "Deflection vs reference"
    value: "Deflection matched closely to reference targets at the sampled checkpoints."
  - label: "Twist (truth targets)"
    value: "Twist targets span ~2.4–2.6°; surrogate integration pending."
  - label: "Core artifact output"
    value: "delta_map_table.csv + generated comparison plots"
validation:
